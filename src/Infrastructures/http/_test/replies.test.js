...
describe('/threads/{threadId}/comments/{commentId}/replies endpoint', () => {
  ...
  describe('when POST /threads/{threadId}/comments/{commentId}/replies', () => {
    ...
    it('should response 400 when request payload not contain needed property', async () => {
      ...
      expect(responseJson.message).toEqual('Gagal menambahkan balasan: data wajib belum lengkap');
    });
    ...
    it('should response 400 when request payload not meet data type specification', async () => {
      ...
      expect(response.statusCode).toEqual(400);
      expect(responseJson.status).toEqual('fail');
      expect(responseJson.message).toEqual('Gagal menambahkan balasan: format data salah');
    });
  ...
  describe('when DELETE /threads/{threadId}/comments/{commentId}/replies/{replyId}', () => {
    ...
    it('should response 403 status code when user is not the owner of the reply', async () => {
      ...
      await UsersTableTestHelper.addUser({ id: otherReplyOwner, username: 'user456' });
